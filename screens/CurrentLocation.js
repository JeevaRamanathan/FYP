          ...
          "legs": [
              {
                  ...
                  "end_address": "39D, Road, Anna Nagar, Tennur, Tiruchirappalli, Tamil Nadu 620026, India",
                  "end_location": {
                      "lat": 10.8170119,
                      "lng": 78.6824929
                  },
                  "start_address": "D65A, 11th B Cross Rd, West Thillai Nagar, Tennur, Tiruchirappalli, Tamil Nadu 620018, India",
                  "start_location": {
                      "lat": 10.8181917,
                      "lng": 78.6814768
                  },
                  "steps": [
                      {
                          ...
                          "html_instructions": "Head <b>south</b> toward <b>E Sathiram Rd</b><div style=\"font-size:0.9em\">Pass by AL-SHIFA ACUPUNCTURE CLINIC (on the left)</div>",
                          "polyline": {
                      ...
                      },
                      {
                          ...
                          "html_instructions": "Turn <b>left</b> at SRK FROST FREEZE TECHNOLOGIES PRIVATE LIMITED onto <b>E Sathiram Rd</b><div style=\"font-size:0.9em\">Pass by Mangalam Residency (on the left)</div>",
                          "maneuver": "turn-left",
                          "polyline": {
                      ...
                      },
                      {
                          ...
                          "html_instructions": "Turn <b>left</b> at Mohanasree readymades onto <b>Bishop Rd</b>/<wbr/><b>Keela Chathiram Rd</b>/<wbr/><b>Thennur High Rd</b>",
                          "maneuver": "turn-left",
                          "polyline": {
                              "points": "gu_aAktf_NAE"
                          },
...
class CurrentLocation extends React.Component {
  ...
  speak(){
    this.state.speak?Tts.stop():  Tts.speak(this.state.msg,
      {
        androidParams: {
          KEY_PARAM_PAN: -1,
  ...
  disCalculation() {
    ...
    axios.post(`https://maps.googleapis.com/maps/api/directions/json?destination=${this.state.distance[0].latitude},${this.state.distance[0].longitude}&origin=${this.state.latitude},${this.state.longitude}&optimize:true&key=AIzaSyCYUfRcy0BLJRO7fuhHsI0dYxJqi0_X_E8`)
    .then((res)=>{
      ...
      var msg  = "Your nearest bus stop is " +this.state.distance[0].name +". Instructions to reach the bus stop \n"
     ...
     <p> <u><b style=\"color:#22333b"\>Distance:</b></u> ${dis} km  -  <u><b style=\"color:#22333b"\>Time:</b></u> ${time} minutes</p>
      ...
      for( var i=0;i<res.data.routes[0].legs[0].steps.length;i++){ 
          ...
          msg += res.data.routes[0].legs[0].steps[i].html_instructions.replace(/<[^>]+>/g, '')+ '\n'
...
<MapViewDirections origin={{latitude: this.state.latitude, longitude: this.state.longitude}} destination={this.state.distance[0]}
...
<MapViewDirections origin={{latitude: this.state.latitude, longitude: this.state.longitude}} destination={this.state.distance[1]}
apikey={GOOGLE_MAPS_APIKEY}
strokeWidth={5}
strokeColor="green"
optimizeWaypoints={true}
...
/>
              ...
              <View style={{height:"30%",marginLeft:10,marginRight:10,backgroundColor:'#fffafa'}}>
            <ScrollView>
            ...
            <Ionicons
                    ...
                    name={this.state.speak?"ios-mic-circle-sharp":"ios-mic-off-circle"}
                    size={40}
                    style={{color: '#b5acba'}}
                  />
</TouchableOpacity>
