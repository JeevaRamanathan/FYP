...
export default class FindBusStop extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      search: '',
        ...
        {this.state.distance.length == 0 ? (
          <View
            ...
            <Text
              ...
              If you are dont know the name of the bus stop, enter the name of
              the place that you need to go. We will provide you the name of the
              bus stage nearest to your searched location.
            </Text>
          </View>
        ) : (
          <></>
            ...
            <ScrollView>
              <View
                ...
                <Text
                  ...
                  Searched address: {(' ', this.state.searchAddress)}
                </Text>
                ...
                <Text
                  ...
                  You can reach {this.state.search} by reaching the bus stop{' '}
                  {(' ', this.state.distance[0].name)} which is the nearest bus
                  stop.
                  {'\n'} The distance from {this.state.distance[0].name} bus
                  stop to {this.state.search} is {this.state.travelDistance}{' '}
                  km.(by walk)
                </Text>
              </View>
            </ScrollView>
