...
export default class RouteDisTimeDetailsUI extends React.Component{
  ...
  render(){  return(
    ...
    <View style={{  height: this.props.value.via==''?140:185,
    width: '100%',
    ...
    fontSize: 16,
    marginLeft: 20,
    marginTop: 20,}}>Route Details </Text>
    
     
    </View>
    {this.props.value.via!=''?
    <Text style={{marginLeft: 65,fontStyle: 'italic',color: '#aaa',fontFamily: 'SourceSansPro-Regular'}}> {this.props.value.via} </Text>
    :<></>}
