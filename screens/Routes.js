...
//   </View>
//   <View style={{marginLeft: 40, marginTop: -10, marginBottom: 20}}>
//     <Text style={sourceTexStyle}>Source</Text>
//     <TextInput
//       style={styles.text}
...
//   <View style={{marginBottom: 170, marginLeft: 40}}>
//     <Text style={DesTexStyle}>Des</Text>
//     <TextInput
//       // {...props}
//       style={styles.text}
