  ...
  disCalculation() {
    ...
    axios
      ...
      .then((res) => {
        ...
        var msg =
          'அருகிலுள்ள பஸ் நிறுத்தம் ' +
          this.state.distance[0].name +
          '.பஸ் நிறுத்தத்தை அடைய அறிவுறுத்தல்கள்\n';
        var html = ` <b style=\"color:#22333b"\>அருகிலுள்ள பஸ் நிறுத்தம் - ${this.state.distance[0].name}.</b>
     <p> <u><b style=\"color:#22333b"\>தூரம்:</b></u> ${dis} கி.மீ.  -  <u><b style=\"color:#22333b"\>நேரம்:</b></u> ${time} நிமிடங்கள்</p>
      <hr/><br>`;
        html += `<u><b style=\"color:#2735a8"\>பஸ் நிறுத்தத்தை அடைய அறிவுறுத்தல்கள்:</b></u>`;
