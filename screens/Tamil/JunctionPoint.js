            ...
            <ScrollView>
              ...
              <View style={{marginTop: 30}}>
                <Text
                  ...
                  இலக்கை அடைய OLA சேவைகளைப் பயன்படுத்தலாம்
                </Text>
                <TouchableOpacity
                  activeOpacity={0.7}
                  onPress={() =>
                    this.props.prop.navigation.navigate('OlaService', {
                      value: {
                        srcCoordinates: this.state.srcCoordinates,
                        desCoordinates: this.state.desCoordinates,
                      },
                    })
                  }
                  style={{
                  ...
                  <Image
                    style={{height: 100, width: '60%', resizeMode: 'stretch'}}
